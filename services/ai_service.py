...
"""
    ...
    def translate_image(self, image, target_lang: str) -> dict:
        """Dịch văn bản trên ảnh (sử dụng trong tính năng OCR - sẽ được cấu hình sau)"""
        # Placeholder cho OCR Image Translation
        return {
            "translation": "Tính năng OCR trên ảnh đang phát triển.",
            "explanation": "",
            "detected_lang": "unknown"
        }
